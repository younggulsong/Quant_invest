...
FILENAME = "190506_슈퍼가치_모멘텀x비중 부채비율100from 180309"
...
모멘텀_1개월_rank = data[모멘텀_6개월].rank(axis=0, ascending = False)
sum_모멘텀_rank = (모멘텀_1개월_rank).rank(axis=0)
...
month_data = month_naver_fromto(stocklist,1,30)
