...
모멘텀_1개월 = "1개월\n등락률\n(%)"
거래대금 = "거래대금\n(억)"
FILE = 'quantking171020.xlsx'
FILENAME = "191013_슈퍼가치_ 가치지표x ,pbr 0.2이상, psr 0 이상, pcr0이상, 거래대금1000이상 from 171020"
...
#data = data[data[모멘텀_1년]>-10]
#data = ltoh_percent(data, '모멘텀_rank', 20)
...
month_data = month_naver_fromto(stocklist,30,48)
