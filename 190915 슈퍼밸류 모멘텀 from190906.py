...
모멘텀_1개월 = "1개월 등락률 (%)"
거래대금 = "거래대금 (20일평균 억)"
FILE = 'quantking190906.xlsx'
FILENAME = "190915_슈퍼밸류모멘텀from 190906"
...
sum_모멘텀_rank = (모멘텀_6개월_rank).rank(axis=0)
...
data = data[data[모멘텀_1년]>-0] # 12개월 모멘텀 0 이상만 남김
...
month_data = month_naver_fromto(stocklist,1,2)
