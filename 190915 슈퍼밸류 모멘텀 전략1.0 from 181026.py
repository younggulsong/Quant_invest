...
FILENAME = "190915_슈퍼밸류 모멘텀(-10이상)from 181026_"
...
sum_모멘텀_rank = (모멘텀_6개월_rank+모멘텀_1년_rank).rank(axis=0)
...
data = data.head(50) # 상위 50종목 선정
print('상위 50종목 선별 후')
print(len(data.index))
data = data[data[모멘텀_1년]>-10] # 12개월 모멘텀 0 이상만 남김
print('12개월 모멘텀>0 선별후')
print(len(data.index))
...
month_data = month_naver_fromto(stocklist,4,22)
