...
FILENAME = "200629_EV_EBITDA 순위, 모멘텀순위 부채 100이하 20종목, from 181026_"
...
sum_rank = (EV_rank+0*sum_가치_rank + sum_모멘텀_rank).rank(axis =0)
...
month_data = month_naver_fromto(stocklist,24,42)
