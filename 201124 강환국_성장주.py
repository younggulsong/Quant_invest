...
FILE = 'quantking191022.xlsx'   #181026, 191022등으로 back test 가능
FILEdate = FILE[9:15]
종목수 = 20
시가총액하위 = 20 #시가총액 하위 퍼센또
FILENAME = "201120_신슈퍼가치, 모멘텀1년o 선별 소형주{시가총액하위} 퍼이하, 차입금비율200, {종목수} 개 from {FILEdate}".format(FILEdate=FILEdate,종목수 = 종목수,시가총액하위=시가총액하위) # per이나 ev나 크게 상관없는것으로 보임..
...
from quant_functions import *
month_data = month_naver_fromto_better(stocklist,'2021-08-22','2021-10-28')
